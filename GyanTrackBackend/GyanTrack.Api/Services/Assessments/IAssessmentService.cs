...
namespace GyanTrack.Api.Services.Assessments
{
    public interface IAssessmentService
    {
        ...
        Task<TestAttemptDTO> MarkAttemptVerifiedAsync(int attemptId);
        Task<IEnumerable<TestAttemptDTO>> GetPendingSubmissionsByEvaluatorAsync(int evaluatorId);
        Task<IEnumerable<TestAttemptDTO>> GetPendingHRVerificationsAsync();
        #endregion
